 ...
 * @author     David White [monkeyphp] <git@monkeyphp.com>
 */
class RecordingResultSetTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $adapter = new \MphpMusicBrainz\Adapter\Xml\ResultSet\RecordingResultSetAdapter($this->xml);
        return $adapter;
    }
    
    /**
     * Test that we can construct an instance of RecordingResultSet
     * 
     * @covers MphpMusicBrainz\ResultSet\RecordingResultSet::__construct()
     */
    public function testCanConstructInstance()
    {
        ...
        $this->assertInstanceOf('MphpMusicBrainz\ResultSet\RecordingResultSet', $recordingResultSet);
    }
    
    /**
     * Test that calling current returns an instance of Recording
     * 
     * @covers MphpMusicBrainz\ResultSet\RecordingResultSet::current()
     */
    public function testCurrent()
    {
        $recordingResultSet = new \MphpMusicBrainz\ResultSet\RecordingResultSet($this->getAdapter(), $this->query, $this->limit);
        
        $recording = $recordingResultSet->current();
        
        $this->assertInstanceOf('MphpMusicBrainz\Result\Recording', $recording);
    }
    
    /**
     * Test that we can retrieve the total number of records available
     * 
     * @covers MphpMusicBrainz\ResultSet\RecordingResultSet::getCount()
     */
     ...
     * 
     * @covers MphpMusicBrainz\ResultSet\RecordingResultSet::current()
     * @covers MphpMusicBrainz\ResultSet\RecordingResultSet::next()
     * @covers MphpMusicBrainz\ResultSet\RecordingResultSet::valid()
     * @covers MphpMusicBrainz\ResultSet\RecordingResultSet::rewind()
     * @covers MphpMusicBrainz\ResultSet\RecordingResultSet::key()
     */
    public function testIterate()
    {
        $resultSet = new \MphpMusicBrainz\ResultSet\RecordingResultSet($this->getAdapter(), $this->query, $this->limit);
